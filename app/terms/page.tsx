      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-gray max-w-none space-y-10 text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <p className="text-sm">
              서비스가 제공하는 이벤트·굿즈 정보는 이용자 및 주최자가 등록·제보한 정보를 기반으로 합니다.
          ...
          <section>
            ...
            <ol className="list-decimal pl-5 space-y-2 text-sm">
              ...
              <li>
                이용자가 등록·제보한 이미지·텍스트 등 콘텐츠에 대한 저작권 책임은 이를 등록한 이용자에게 있으며,
                이용자는 제3자의 저작권 등 권리를 침해하지 않는 콘텐츠만 등록해야 합니다.
              </li>
              <li>
                권리자는 자신의 저작물이 무단으로 게시되었다고 판단할 경우 아래 이메일로 신고할 수 있으며,
                서비스는 신고 내용을 확인한 후 지체 없이 해당 콘텐츠를 삭제 등 필요한 조치를 취합니다.
                <br />
                <span className="font-medium text-gray-900">권리침해 신고: gkimth7@gmail.com</span>
              </li>
            </ol>
          </section>
