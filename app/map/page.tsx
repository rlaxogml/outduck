          ...
          <div className="block md:hidden shrink-0 px-4 pt-3 pb-3">
            ...
            {isMapReady && filteredEvents.length > 0 && (
              <button
                ...
                className="absolute right-8 bottom-[calc(env(safe-area-inset-bottom,0px)_+_4rem)] md:bottom-4 md:right-4 z-40 flex h-10 items-center gap-2 rounded-xl border border-border bg-background/90 backdrop-blur-sm px-3.5 font-bold text-foreground shadow-xl hover:bg-accent hover:text-accent-foreground hover:border-border/80 transition-all duration-200 hover:scale-[1.02] active:scale-[0.97]"
